...
(function initJodTheme(global) {
	...
	var DARK_CSS_HREF = "css/theme-dark.css?v=14";
	var AUTH_PAGES = {
 "login.html": 1,
 "signup.html": 1,
 "verify-email.html": 1,
...
(function initJodHeaderBack(global) {
	...
	function fallbackHref(btn) {
		...
		if (page === "orders.html" || page === "settings.html" || page === "notifications.html" || page === "dashboard.html") {
			return pretty(page === "dashboard.html" ? "index.html" : "dashboard.html");
		}
